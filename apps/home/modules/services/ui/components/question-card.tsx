...
import { normalizeOptionLabel, BANGLA_LABELS, getCorrectLetter } from "@/lib/mcq";
...
// ✅ Bangla labels removed - now using shared constants from @/lib/mcq
      ...
      <CardContent className="p-4">
        ...
        <div className="space-y-1.5">
          {mcq.options.map((option, index) => {
            ...
            const isSelected = normalizeOptionLabel(selectedOption) === normalizeOptionLabel(optionLetterEnglish);
            const isCorrectAnswer = normalizeOptionLabel(correctLetter) === normalizeOptionLabel(optionLetterEnglish);
